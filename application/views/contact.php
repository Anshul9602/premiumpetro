			...
			<div class="col-lg-6 col-xl-7 ls ">
				<div class="special-column">
					...
					<p class="special-heading text-left">
						...
						<span>
						Your feedback is important to us. Write to us at info@premiumpetro.in or contact us at +91 8441095087 or +91 6367863214
						</span>
					</p>
				...
				<div class="special-column2">
					...
					<div class="media text-center text-sm-left">
						...
						<div class="media-body">
							...
							<p class="">1-3, Hathroi Market, Ajmer Rd, opp. Gopal Bari, Jaipur, Rajasthan. 302001</p>
						</div>
					</div>
					<div class="divider-50 hidden-below-lg"></div>
					<div class="divider-30 hidden-above-lg"></div>
					...
					<div class="media text-center text-sm-left">
						...
						<div class="media-body">
							...
							<p class="" style="margin-bottom:0px;">+91 8441095087</p>
                            <p class="">+91 6367863214 </p>
						</div>
					</div>
					<div class="divider-50 hidden-below-lg"></div>
					<div class="divider-30 hidden-above-lg"></div>
					...
					<div class="media text-center text-sm-left">
						...
						<div class="media-body">
							...
							<p class="">info@premiumpetro.in</p>
						</div>
					</div>
					<div class="divider-50 hidden-below-lg"></div>
					<div class="divider-30 hidden-above-lg"></div>
					...
					<span class="social-icons">
						<a target="_blank" href="https://www.facebook.com/premiumpetroproducts" class="fab fa-facebook-f bg-icon light-bg rounded-icon"></a>
						<a target="_blank" href="https://www.linkedin.com/company/premium-petro-products/" class="fab fa-linkedin-in bg-icon light-bg rounded-icon"></a>
						<a target="_blank" href="https://www.instagram.com/premium_petro_products/" class="fab fa-instagram bg-icon light-bg rounded-icon"></a>
						<a target="_blank" href="https://twitter.com/PetroPremium" class="fab fa-twitter rounded-icon bg-icon light-bg" title="telegram"></a>
...
<section>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3557.6405762042623!2d75.79302311504497!3d26.914899783126685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDU0JzUzLjYiTiA3NcKwNDcnNDIuOCJF!5e0!3m2!1sen!2sin!4v1631261721670!5m2!1sen!2sin" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
</section>


<section class="ls s-py-0 container-px-0 d-none">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<div class=" ms page_map" data-draggable="false" data-scrollwheel="false">
					<div class="marker">
						<div class="marker-address">Premium Petro Products, Ajmer Road, opp. Gopal Bari, Uma Colony, Shanti Nagar, DCM, Jaipur, Rajasthan, India</div>
							...
							<ul class="list-unstyled">
								<li>
									<span class="icon-inline">
										...
										<span>
											Premium Petro
											1-3, Hathroi Market, Ajmer Rd, opp. Gopal Bari, Jaipur, Rajasthan. 302001
