			...
			<div class="col-md-6">
				...
				<div class="card text-center mt-4"
					...
					<div class="card-body">
							...
							<div class="byline">
								<span class="date">
									<a href="<?php echo base_url() . 'blog/post/' . $posts[$i]['url'] ?>"
										rel="bookmark"style="color: #1475B5;font-weight: 700;">
						...
						<a class="btn btn-gradient "style="padding:10px 20px;"
							href="<?php echo base_url() . 'blog/post/' . $posts[$i]['url'] ?>">read more</a><br>
					</div>
				</div>	<?php } ?>
